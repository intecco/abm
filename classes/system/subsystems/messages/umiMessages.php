...
SQL;   l_mysql_query($vac5c74b64b4b8352ef2f181affb5ac2a);$v009bc6ca542405d9097ae589731691fb = l_mysql_insert_id();return new umiMessage($v009bc6ca542405d9097ae589731691fb);}static public function getAllowedTypes() {return self::$messageTypes;}private function getCurrentUserId() {$v41275a535677f79ff347e01bc530c176 = permissionsCollection::getInstance();return $v41275a535677f79ff347e01bc530c176->getUserId();}private function checkMessageType($v9cebbecc0f683775cabcd1c6dd3d70c7) {return in_array($v9cebbecc0f683775cabcd1c6dd3d70c7, self::getAllowedTypes());}};?>
