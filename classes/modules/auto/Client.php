<?php
require_once(dirname(__FILE__).'/maxAPI/maxCacheHtmlClient.php');
...
class demoClient extends maxCacheHtmlClient
{
  ...
  protected function getDefaultOptions()
  {
    return array_merge(
      ...
      array(
        ...
        'rows_by_page' => regedit::getInstance()->getVal("//modules/auto/per_page"),
      )
    );
  }
   ...
   * @return this
   */
  public function setRequest($utype)
  {
    ...
    if ($utype == 1)
    {
      // Устанавливаем тему запроса vehicles
        ...
        {
          // При обнаружении невалидного значения максимально быстро выбрасываем exception, до запроса XML
    ...
    else 
    {
      ...
      $this->setRequestThemeName($_GET['a']);
    }
