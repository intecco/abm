...
<xsl:stylesheet	version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/udata/object">
		...
		<xsl:variable name="delivery-address" select="document(concat('uobject://', $delivery/property[@name='delivery_address']/value/item[1]/@id))/udata/object/properties/group" />
                <xsl:variable name="user-info" select="document(concat('uobject://', @id))/udata" />
		<html>
			<head>
...
<!--						<td class="title">
						...
						<td class="value">
							<xsl:value-of select="$delivery-address/property[@name='region']/value" />
                                                        <xsl:value-of select="$user-info/property[@name='region']/value" />
						</td>-->
						<td class="title">
							Стоимость доставки:
						</td>
						<td class="value">
							...
							<!--<xsl:value-of select="$delivery/property[@name='delivery_price']/value" />-->
                                                        <xsl:value-of select="document(concat('uobject://',$delivery/property[@name='delivery_id']/value/item/@id))//property[@name='price']/value"/>
							<xsl:text>&#160;</xsl:text>
...
<!--					<tr>
						...
						<td class="value">
							<xsl:value-of select="$delivery-address/property[@name='city']/value" />
                                                        <xsl:value-of select="//property[@name='gorod']/value" />
						</td>						
					</tr>-->
<!--					<tr>
						<td class="title">
...
<!--					<tr>
						...
						<td class="value">
							<xsl:value-of select="$delivery-address/property[@name='house']/value" />
                                                        <xsl:value-of select="//property[@name='dom']/value" />
						</td>						
					</tr>-->
<!--					<tr>
						<td class="title">
						...
						<td class="value">
							<xsl:value-of select="$delivery-address/property[@name='flat']/value" />
                                                        <xsl:value-of select="//property[@name='kvartira']/value" />
						</td>						
					</tr>-->
...
<p>Комментарий к заказу: <xsl:value-of select="$order/property[@name='order_comment']/value" /></p>
	...
	<xsl:template match="object" mode="customer">				
		...
		<tr>
			...
			<td class="value">
				<xsl:value-of select="//property[@name='adres_dostavki']/value" />
			</td>
			<td class="title">
				Комментарий:
			</td>
			<td class="value">
                ...
                <tr>
                    ...
                    <td class="value">
                        <xsl:value-of select="//property[@name='phone_user']/value" />
                    </td>
                </tr>
